...
describe('unauthorized()', function () {
    ...
    it('returns a WWW-Authenticate header when passed a schema', function (done) {
    ...
    it('returns a WWW-Authenticate header when passed a schema and attributes', function (done) {
